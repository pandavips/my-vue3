...
function effect(fn, options) {
    ...
    extend(_effect, { onStop: options === null || options === void 0 ? void 0 : options.onStop });
    _effect.run();
...
function createRender(options) {
    ...
    const { createElement: hostCreateElement, insert: hostInsert, patchProp: hostPatchprp, remove: hostRemove, setElementText: hostSetElementText, } = options;
